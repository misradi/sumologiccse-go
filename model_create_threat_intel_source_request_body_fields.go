...
func (o *CreateThreatIntelSourceRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCreateThreatIntelSourceRequestBodyFields)
