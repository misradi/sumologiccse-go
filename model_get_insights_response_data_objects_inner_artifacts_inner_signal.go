...
func (o *GetInsightsResponseDataObjectsInnerArtifactsInnerSignal) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetInsightsResponseDataObjectsInnerArtifactsInnerSignal)
