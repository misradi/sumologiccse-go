...
func (o *GetEntitiesResponseDataObjectsInnerInventoryInnerOneOf1) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetEntitiesResponseDataObjectsInnerInventoryInnerOneOf1)
