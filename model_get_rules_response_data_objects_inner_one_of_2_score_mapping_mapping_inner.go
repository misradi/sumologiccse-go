...
func (o *GetRulesResponseDataObjectsInnerOneOf2ScoreMappingMappingInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetRulesResponseDataObjectsInnerOneOf2ScoreMappingMappingInner)
