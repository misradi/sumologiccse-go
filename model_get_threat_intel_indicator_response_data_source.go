...
func (o *GetThreatIntelIndicatorResponseDataSource) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetThreatIntelIndicatorResponseDataSource)
