...
func (o *GetRulesResponseDataObjectsInnerOneOfStatus) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetRulesResponseDataObjectsInnerOneOfStatus)
