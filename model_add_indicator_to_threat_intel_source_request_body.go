...
func (o *AddIndicatorToThreatIntelSourceRequestBody) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varAddIndicatorToThreatIntelSourceRequestBody)
