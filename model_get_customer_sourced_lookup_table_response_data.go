...
func (o *GetCustomerSourcedLookupTableResponseData) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetCustomerSourcedLookupTableResponseData)
