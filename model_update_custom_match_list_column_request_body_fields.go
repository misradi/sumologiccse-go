...
func (o *UpdateCustomMatchListColumnRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateCustomMatchListColumnRequestBodyFields)
