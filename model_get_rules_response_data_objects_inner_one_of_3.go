...
// checks if the GetRulesResponseDataObjectsInnerOneOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRulesResponseDataObjectsInnerOneOf3{}

// GetRulesResponseDataObjectsInnerOneOf3 struct for GetRulesResponseDataObjectsInnerOneOf3
type GetRulesResponseDataObjectsInnerOneOf3 struct {
...
type _GetRulesResponseDataObjectsInnerOneOf3 GetRulesResponseDataObjectsInnerOneOf3
...
func NewGetRulesResponseDataObjectsInnerOneOf3(contentType string, created time.Time, createdBy string, deleted bool, enabled bool, entitySelectors []GetRulesResponseDataObjectsInnerOneOfEntitySelectorsInner, id string, isPrototype bool, lastUpdated time.Time, lastUpdatedBy string, name string, status GetRulesResponseDataObjectsInnerOneOfStatus, ruleId int32, ruleSource string, ruleType string, signalCount07d int32, signalCount24h int32, summaryExpression string, tags []string, hasOverride bool, assetField string, description string, expressionsAndLimits []GetRulesResponseDataObjectsInnerOneOf3ExpressionsAndLimitsInner, groupByFields []string, ordered bool, score int32, stream string, version int32, windowSize int32, windowSizeName string) *GetRulesResponseDataObjectsInnerOneOf3 {
	this := GetRulesResponseDataObjectsInnerOneOf3{}
...
func (o GetRulesResponseDataObjectsInnerOneOf3) MarshalJSON() ([]byte, error) {
...
func (o GetRulesResponseDataObjectsInnerOneOf3) ToMap() (map[string]interface{}, error) {
...
func (o *GetRulesResponseDataObjectsInnerOneOf3) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetRulesResponseDataObjectsInnerOneOf3 := _GetRulesResponseDataObjectsInnerOneOf3{}

	err = json.Unmarshal(bytes, &varGetRulesResponseDataObjectsInnerOneOf3)

	if err != nil {
		return err
	}

	*o = GetRulesResponseDataObjectsInnerOneOf3(varGetRulesResponseDataObjectsInnerOneOf3)

	return err
}

type NullableGetRulesResponseDataObjectsInnerOneOf3 struct {
	value *GetRulesResponseDataObjectsInnerOneOf3
	isSet bool
}

func (v NullableGetRulesResponseDataObjectsInnerOneOf3) Get() *GetRulesResponseDataObjectsInnerOneOf3 {
	return v.value
}

func (v *NullableGetRulesResponseDataObjectsInnerOneOf3) Set(val *GetRulesResponseDataObjectsInnerOneOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRulesResponseDataObjectsInnerOneOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRulesResponseDataObjectsInnerOneOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRulesResponseDataObjectsInnerOneOf3(val *GetRulesResponseDataObjectsInnerOneOf3) *NullableGetRulesResponseDataObjectsInnerOneOf3 {
	return &NullableGetRulesResponseDataObjectsInnerOneOf3{value: val, isSet: true}
}

func (v NullableGetRulesResponseDataObjectsInnerOneOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRulesResponseDataObjectsInnerOneOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
