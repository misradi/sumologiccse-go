...
func (o *GetInsightRelatedEntitiesResponseDataInvolvedEntitiesInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetInsightRelatedEntitiesResponseDataInvolvedEntitiesInner)
