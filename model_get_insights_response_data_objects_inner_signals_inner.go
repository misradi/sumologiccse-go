...
func (o *GetInsightsResponseDataObjectsInnerSignalsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetInsightsResponseDataObjectsInnerSignalsInner)
