...
func (o *CreateLogMappingRequestBodyFieldsFieldsInnerLookupInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCreateLogMappingRequestBodyFieldsFieldsInnerLookupInner)
