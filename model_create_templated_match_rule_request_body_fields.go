...
func (o *CreateTemplatedMatchRuleRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCreateTemplatedMatchRuleRequestBodyFields)
