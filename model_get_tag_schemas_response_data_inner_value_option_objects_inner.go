...
func (o *GetTagSchemasResponseDataInnerValueOptionObjectsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetTagSchemasResponseDataInnerValueOptionObjectsInner)
