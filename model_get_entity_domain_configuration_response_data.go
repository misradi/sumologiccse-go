...
func (o *GetEntityDomainConfigurationResponseData) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetEntityDomainConfigurationResponseData)
