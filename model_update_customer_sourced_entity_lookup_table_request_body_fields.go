...
func (o *UpdateCustomerSourcedEntityLookupTableRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateCustomerSourcedEntityLookupTableRequestBodyFields)
