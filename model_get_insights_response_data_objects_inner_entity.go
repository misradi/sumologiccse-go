...
func (o *GetInsightsResponseDataObjectsInnerEntity) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetInsightsResponseDataObjectsInnerEntity)
