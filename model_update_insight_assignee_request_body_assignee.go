...
func (o *UpdateInsightAssigneeRequestBodyAssignee) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateInsightAssigneeRequestBodyAssignee)
