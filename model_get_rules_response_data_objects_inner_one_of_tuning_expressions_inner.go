...
func (o *GetRulesResponseDataObjectsInnerOneOfTuningExpressionsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetRulesResponseDataObjectsInnerOneOfTuningExpressionsInner)
