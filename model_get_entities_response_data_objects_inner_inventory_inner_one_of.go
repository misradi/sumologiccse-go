...
func (o *GetEntitiesResponseDataObjectsInnerInventoryInnerOneOf) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetEntitiesResponseDataObjectsInnerInventoryInnerOneOf)
