...
// checks if the GetRulesResponseDataObjectsInnerOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetRulesResponseDataObjectsInnerOneOf1{}

// GetRulesResponseDataObjectsInnerOneOf1 struct for GetRulesResponseDataObjectsInnerOneOf1
type GetRulesResponseDataObjectsInnerOneOf1 struct {
...
type _GetRulesResponseDataObjectsInnerOneOf1 GetRulesResponseDataObjectsInnerOneOf1
...
func NewGetRulesResponseDataObjectsInnerOneOf1(contentType string, created time.Time, createdBy string, deleted bool, enabled bool, entitySelectors []GetRulesResponseDataObjectsInnerOneOfEntitySelectorsInner, id string, isPrototype bool, lastUpdated time.Time, lastUpdatedBy string, name string, status GetRulesResponseDataObjectsInnerOneOfStatus, ruleId int32, ruleSource string, ruleType string, signalCount07d int32, signalCount24h int32, summaryExpression string, tags []string, hasOverride bool, assetField string, countDistinct bool, description string, expression string, groupByFields []string, limit int32, score int32, stream string, version int32, windowSize int32, windowSizeName string) *GetRulesResponseDataObjectsInnerOneOf1 {
	this := GetRulesResponseDataObjectsInnerOneOf1{}
...
func (o GetRulesResponseDataObjectsInnerOneOf1) MarshalJSON() ([]byte, error) {
...
func (o GetRulesResponseDataObjectsInnerOneOf1) ToMap() (map[string]interface{}, error) {
...
func (o *GetRulesResponseDataObjectsInnerOneOf1) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetRulesResponseDataObjectsInnerOneOf1 := _GetRulesResponseDataObjectsInnerOneOf1{}

	err = json.Unmarshal(bytes, &varGetRulesResponseDataObjectsInnerOneOf1)

	if err != nil {
		return err
	}

	*o = GetRulesResponseDataObjectsInnerOneOf1(varGetRulesResponseDataObjectsInnerOneOf1)

	return err
}

type NullableGetRulesResponseDataObjectsInnerOneOf1 struct {
	value *GetRulesResponseDataObjectsInnerOneOf1
	isSet bool
}

func (v NullableGetRulesResponseDataObjectsInnerOneOf1) Get() *GetRulesResponseDataObjectsInnerOneOf1 {
	return v.value
}

func (v *NullableGetRulesResponseDataObjectsInnerOneOf1) Set(val *GetRulesResponseDataObjectsInnerOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableGetRulesResponseDataObjectsInnerOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableGetRulesResponseDataObjectsInnerOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetRulesResponseDataObjectsInnerOneOf1(val *GetRulesResponseDataObjectsInnerOneOf1) *NullableGetRulesResponseDataObjectsInnerOneOf1 {
	return &NullableGetRulesResponseDataObjectsInnerOneOf1{value: val, isSet: true}
}

func (v NullableGetRulesResponseDataObjectsInnerOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetRulesResponseDataObjectsInnerOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
