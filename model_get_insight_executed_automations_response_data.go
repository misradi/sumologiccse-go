...
func (o *GetInsightExecutedAutomationsResponseData) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetInsightExecutedAutomationsResponseData)
