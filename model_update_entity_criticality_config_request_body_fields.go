...
func (o *UpdateEntityCriticalityConfigRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateEntityCriticalityConfigRequestBodyFields)
