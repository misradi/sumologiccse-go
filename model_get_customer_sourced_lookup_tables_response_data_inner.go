...
// checks if the GetCustomerSourcedLookupTablesResponseDataInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetCustomerSourcedLookupTablesResponseDataInner{}

// GetCustomerSourcedLookupTablesResponseDataInner struct for GetCustomerSourcedLookupTablesResponseDataInner
type GetCustomerSourcedLookupTablesResponseDataInner struct {
	Id string `json:"id"`
...
type _GetCustomerSourcedLookupTablesResponseDataInner GetCustomerSourcedLookupTablesResponseDataInner
...
func NewGetCustomerSourcedLookupTablesResponseDataInner(id string, tableId string, contentId string, type_ string, keyColumnName string, valueColumnName string) *GetCustomerSourcedLookupTablesResponseDataInner {
	this := GetCustomerSourcedLookupTablesResponseDataInner{}
	this.Id = id
...
// and a boolean to check if the value has been set.
func (o *GetCustomerSourcedLookupTablesResponseDataInner) GetTablePathOk() (*string, bool) {
	if o == nil || IsNil(o.TablePath) {
		return nil, false
	}
...
func (o GetCustomerSourcedLookupTablesResponseDataInner) MarshalJSON() ([]byte, error) {
...
func (o GetCustomerSourcedLookupTablesResponseDataInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetCustomerSourcedLookupTablesResponseDataInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetCustomerSourcedLookupTablesResponseDataInner := _GetCustomerSourcedLookupTablesResponseDataInner{}

	err = json.Unmarshal(bytes, &varGetCustomerSourcedLookupTablesResponseDataInner)

	if err != nil {
		return err
	}

	*o = GetCustomerSourcedLookupTablesResponseDataInner(varGetCustomerSourcedLookupTablesResponseDataInner)

	return err
}

type NullableGetCustomerSourcedLookupTablesResponseDataInner struct {
	value *GetCustomerSourcedLookupTablesResponseDataInner
	isSet bool
}

func (v NullableGetCustomerSourcedLookupTablesResponseDataInner) Get() *GetCustomerSourcedLookupTablesResponseDataInner {
	return v.value
}

func (v *NullableGetCustomerSourcedLookupTablesResponseDataInner) Set(val *GetCustomerSourcedLookupTablesResponseDataInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetCustomerSourcedLookupTablesResponseDataInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetCustomerSourcedLookupTablesResponseDataInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetCustomerSourcedLookupTablesResponseDataInner(val *GetCustomerSourcedLookupTablesResponseDataInner) *NullableGetCustomerSourcedLookupTablesResponseDataInner {
	return &NullableGetCustomerSourcedLookupTablesResponseDataInner{value: val, isSet: true}
}

func (v NullableGetCustomerSourcedLookupTablesResponseDataInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetCustomerSourcedLookupTablesResponseDataInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
