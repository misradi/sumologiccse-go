...
func (o *GetInsightsResponseDataObjectsInnerSignalsInnerArtifactsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varGetInsightsResponseDataObjectsInnerSignalsInnerArtifactsInner)
