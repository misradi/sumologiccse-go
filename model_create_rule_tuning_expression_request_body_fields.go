...
func (o *CreateRuleTuningExpressionRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCreateRuleTuningExpressionRequestBodyFields)
