...
func (o *BulkUpdateEntityCriticalityResponseDataInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varBulkUpdateEntityCriticalityResponseDataInner)
