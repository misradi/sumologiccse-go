...
func (o *CreateLogMappingRequestBodyFieldsFieldsInner) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varCreateLogMappingRequestBodyFieldsFieldsInner)
