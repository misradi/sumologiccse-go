...
func (o *OverrideAggregationRuleRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varOverrideAggregationRuleRequestBodyFields)
