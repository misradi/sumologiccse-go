...
func (o *UpdateTemplatedMatchRuleRequestBodyFields) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varUpdateTemplatedMatchRuleRequestBodyFields)
