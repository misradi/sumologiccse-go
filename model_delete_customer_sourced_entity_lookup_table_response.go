...
func (o *DeleteCustomerSourcedEntityLookupTableResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	err = json.Unmarshal(bytes, &varDeleteCustomerSourcedEntityLookupTableResponse)
